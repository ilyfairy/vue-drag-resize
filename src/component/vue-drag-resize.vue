    ...
    methods: {
        ...
        bodyMove(delta) {
            ...
            if (this.snapToGrid) {
                ...
                let diffR =
                    parentWidth - newRight - Math.floor((parentWidth - newRight) / gridX) * gridX;
        ...
        stickMove(delta) {
            ...
            switch (currentStick[0]) {
                case 'b':
                    ...
                    if (snapToGrid) {
                        newBottom =
                            parentHeight - Math.round((parentHeight - newBottom) / gridY) * gridY;
                    }
        ...
        rectCorrectionByAspectRatio(rect) {
            ...
            const { parentWidth, parentHeight, currentStick, aspectFactor, dimensionsBeforeMove } =
                this;
